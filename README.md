...
<img src="https://github.com/FrancisTR/BubbleChat-App/assets/123771828/dd763b36-dcb7-4608-ac16-e8aba615654f" width="50%" />
...
There are two people named Rick and Roll. They both set up their info on the main page.
...
### Snapshot of the chat room
Rick then creates the room. Rick shares the code to Roll, which Roll joins Rick's room. The outline of the text bubble shows two different colors. The blue outline indicate that the user sent the message. The orange outline indicates other user's bubble message in that room other than themselves. Snapshot of the chat room is shown below:

<img width="100%" src="https://github.com/FrancisTR/BubbleChat-App/assets/123771828/3ad877a8-9071-4f73-a365-3346b5a896b1" />
